...
<head>
    ...
    <style>
       ...
       body, html { margin: 0; padding: 0; height: 100%; font-family: 'Segoe UI', sans-serif; background-color: #f0f4f8; display: flex; flex-direction: column; }
        ...
        .wrapper h1 { font-size: 28px; color:  #0600BB; margin: 0; }
        table { width: 100%; border-collapse: collapse; font-size: 1rem; }
        th, td { padding: 15px; text-align: left; border-bottom: 1px solid #dee2e6; }
        thead th { background-color: #1911EE; color: white; font-weight: 600; text-transform: uppercase; font-size: 0.9rem; }
        ...
        .button { padding: 10px 20px; border: none; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; text-decoration: none; text-align: center; transition: all 0.2s ease; background-color: #1911EE; color: white; }
        .button:hover { background-color: #0600BB; }
